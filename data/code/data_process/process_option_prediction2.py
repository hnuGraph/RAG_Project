...
if __name__ == "__main__":
    option_path="../LLaMA-Factory/saves/qwen2.5-7B/lora/sft_option_inference2/generated_predictions.jsonl"
    option_path2="../LLaMA-Factory/saves/qwen2.5-7B/lora/sft_option_inference2/generated_predictions.json"
    ...
    save_json_data(option_data_processed,"../../user_data/option_data/test_with_predict_option2.json")