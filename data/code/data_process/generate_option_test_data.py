...
if __name__ == "__main__":
    ...
    # 生成测试数据并格式化
    test_data_path="../../user_data/rule_data/test_with_predict_rule.json"
    test_data=get_json_data(test_data_path)
    test_data_with_rule_text = data_with_rule_text(test_data,rule_data)
    save_json_data(test_data_with_rule_text ,"../../user_data/option_data/test_data.json")
    test_data_formatted = generate_formatted_data(test_data_with_rule_text)
    save_json_data(test_data_formatted,"../LLaMA-Factory/data/option_inference.json")
