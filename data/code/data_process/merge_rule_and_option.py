...
if __name__ == "__main__":
    rule_path="../../user_data/rule_data/test_with_predict_rule.json"
    option_path="../../user_data/option_data/test_with_predict_option.json"
    rule_data=get_json_data(rule_path)
    option_data=get_json_data(option_path)
    result=merge_result(rule_data,option_data)
    save_json_data(result,"../../prediction_result/result.json")